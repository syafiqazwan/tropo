...
public class Fetch_PENYELIDIKAN extends Activity {
    ArrayList<Data> dataList = new ArrayList<Data>();
    String url ="http://tropopsis2015.net84.net/database/upenyelidikan&inovasi.json";
    ...
    public class BackTask extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            DataAdapter adapter = new DataAdapter(Fetch_PENYELIDIKAN.this, R.layout.data_list_items, dataList);

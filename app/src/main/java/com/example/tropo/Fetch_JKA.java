...
public class Fetch_JKA extends Activity {
    ArrayList<Data> dataList = new ArrayList<Data>();
    String url ="http://tropopsis2015.net84.net/database/jtmk.json";
    ...
    public class BackTask extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            DataAdapter adapter = new DataAdapter(Fetch_JKA.this, R.layout.data_list_items, dataList);

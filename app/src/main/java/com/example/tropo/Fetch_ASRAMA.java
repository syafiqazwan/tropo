 ...
 */
//fetch utk semua STAFF ASRAMA
public class Fetch_ASRAMA extends Activity {
    ...
    public class BackTask extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            DataAdapter adapter = new DataAdapter(Fetch_ASRAMA.this, R.layout.data_list_items, dataList);

...
public class Fetch_JTMK_hp1 extends Activity {
    ArrayList<Data> dataList = new ArrayList<Data>();
    String url ="http://tropopsis2015.net84.net/database/jtmk_hp1.json";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fetch_jtmk_hp1);
    ...
    public class BackTask extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            DataAdapter adapter = new DataAdapter(Fetch_JTMK_hp1.this, R.layout.data_list_items, dataList);

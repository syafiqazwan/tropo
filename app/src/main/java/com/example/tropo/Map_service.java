...
public class Map_service extends FragmentActivity implements
    ...
    private static final LatLng KOOP = new LatLng(3.811491, 100.817420);
    ...
    private void setUpMap() {
        ...
        mMap.addMarker(new MarkerOptions().position(KOOP).title("Koperasi Pentadbiran").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA)));
        mMap.addMarker(new MarkerOptions().position(KAFE_ASRAMA).title("Koperasi Asrama").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA)));
        mMap.addMarker(new MarkerOptions().position(KAFE_ASRAMA).title("Cafe Asrama").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA)));
        mMap.addMarker(new MarkerOptions().position(JHEP).title("Cafe Pentadbiran").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA)));
        mMap.addMarker(new MarkerOptions().position(PENTADBIRAN).title("Kaunter Pertanyaan").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_MAGENTA)));
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker arg0) {
                ...
                if (arg0.getTitle().equals("Legend")) {
                    Dialog settingsDialog = new Dialog(Map_service.this);
                    ...
                    alertDialog = new AlertDialog.Builder(Map_service.this);
                    String names[] ={"Koperasi Pentadbiran", "Koperasi Asrama", "Kafe Asrama", "Kafe Admin", "Kaunter Pertanyaan", "Barangan POS", "Library"};
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(Map_service.this, android.R.layout.simple_list_item_1, names);
                    ...
                    lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        public void onItemClick(AdapterView<?> parent, View view,
                            ...
                            if (position == 0)
                            {
                                polyline = mMap.addPolyline((new PolylineOptions()).add(latLng, KOOP).width(6).color(Color.BLUE).geodesic(true));
                            }
                            else if (position == 1)
                            {
                    ...
                    alertDialog = new AlertDialog.Builder(Map_service.this);
                    alertDialog.setTitle("Koperasi Pentadbiran");
                    ...
                    alertDialog = new AlertDialog.Builder(Map_service.this);
                    alertDialog.setTitle("Koperasi Asrama");
                    ...
                    alertDialog = new AlertDialog.Builder(Map_service.this);
                    alertDialog.setTitle("Cafe Asrama");
                    ...
                    alertDialog = new AlertDialog.Builder(Map_service.this);
                    alertDialog.setTitle("Cafe Pentadbiran");
                    alertDialog.setMessage("Menjual makanan & minuman");
                    alertDialog.show();
                    ...
                    alertDialog = new AlertDialog.Builder(Map_service.this);
                    alertDialog.setTitle("Kaunter Pertanyaan");
                    alertDialog.setMessage("Sebarang pertanyaan");
                    alertDialog.show();

                }
                else if (arg0.getTitle().equals("POS - JHEP")) {
                    alertDialog = new AlertDialog.Builder(Map_service.this);
                    alertDialog.setTitle("POS - JHEP");
                    alertDialog.setMessage("Barangan POS");
                    alertDialog.show();

                }
                else if (arg0.getTitle().equals("Library")) {
                    alertDialog = new AlertDialog.Builder(Map_service.this);
                    ...
                    Intent intent = new Intent(Map_service.this, Map_JTMK_JMSK.class);
                    startActivity(intent);
                }
                Toast.makeText(Map_service.this, arg0.getTitle(), Toast.LENGTH_SHORT).show();

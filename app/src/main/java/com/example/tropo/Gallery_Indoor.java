...
public class Gallery_Indoor extends Activity {
    private GridView gv;
    ...
    private int thumb[] = { R.drawable.test2, R.drawable.test2,
            R.drawable.test2, R.drawable.test2, R.drawable.test2,
            R.drawable.test2, R.drawable.test2,
            R.drawable.test2, R.drawable.test2,
            R.drawable.test2, R.drawable.test2, R.drawable.test2,
            R.drawable.test2, R.drawable.test2, R.drawable.test2, R.drawable.test2, R.drawable.test2, R.drawable.test2};
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        public ImageAdapter(Gallery_Indoor activity) {

...
/**
 * Created by Ilfakluz on 13/7/2015.
 */
 ...
 */
//fetch utk semua staff upli
public class Fetch_WANG extends Activity {
    ArrayList<Data> dataList = new ArrayList<Data>();
    String url ="http://tropopsis2015.net84.net/database/ukewangan.json";
    ...
    public class BackTask extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            DataAdapter adapter = new DataAdapter(Fetch_WANG.this, R.layout.data_list_items, dataList);

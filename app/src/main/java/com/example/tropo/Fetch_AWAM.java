 ...
 */
//fetch utk semua STAFF PERHUBUNGAN AWAM
public class Fetch_AWAM extends Activity {
    ...
    public class BackTask extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            DataAdapter adapter = new DataAdapter(Fetch_AWAM.this, R.layout.data_list_items, dataList);
